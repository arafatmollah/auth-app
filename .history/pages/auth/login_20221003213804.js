...
import { getAuth, getRedirectResult, GoogleAuthProvider, GoogleAuthProvider } from "firebase/auth";
    ...
    <div>
        ...
        <div>
            ...
            <div className='flex flex-col w-30 justify-center align-middle mt-5 shadow-xl py-10 px-5'>
                <button onClick={auth} className='bg-gray-700 text-white w-full flex align-middle gap-2 p-4 rounded-lg'>
