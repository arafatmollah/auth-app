  ...
  return (
    <div>
        <div className='mx-30'>
            ...
            <div className='flex flex-col w-4/5 mx-auto justify-center align-middle mt-5 shadow-xl py-10 px-5'>
            <p className='text-center font-semibold my-5 text-teal-800'>Log In here</p>
            <p className='my-5 text-gray-700 text-center'>Get Full acess of my accoount and see what you want to do for (let index = 0; index < array.length; index++) {
