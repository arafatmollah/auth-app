...
const fbLogIn = async () =>{
 try{
  const fb = await signInWithPopup(auth,FacebookAuthProvider)
  console
 } 
}
    ...
    <div>
        ...
        <div>
            ...
            <div className='flex flex-col w-30 justify-center align-middle mt-5 shadow-xl py-10 px-5'>
                ...
                <button onClick={fbLogIn} className='bg-gray-700 text-white mt-5 flex align-middle p-4 gap-2 w-full rounded-lg'>
